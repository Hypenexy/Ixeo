...
<body>
    ...
    <script>var sc;document.onscroll = function(){if(!sc){sc=document.createElement('script');sc.src = "load.php";document.head.appendChild(sc)}} <?php if(isset($_SESSION['dark'])){echo";var dsc = document.createElement('script');dsc.src = 'dark.js';document.head.appendChild(dsc)";}?></script>
</body>
</html>